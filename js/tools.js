...
const createApp = async () => {
    try {
        ...
        for (const client of clients) {
            let ul = document.querySelector('.user__list-tools')
            ...
            titleTalent.innerHTML = 'Талант: ' + client.talent.slice(0, 27)
            ...
            li.append(lookVideo)
            li.append(modal)
            if (client.talent === 'Инструментальное выступление (все виды инструменталки)') {
                ul.append(li)
            }
