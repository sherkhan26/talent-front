...
export const createClientsForm = () => {
    ...
    inputParentName.placeholder = 'Имя Родителя'
    inputParentSurname.placeholder = 'Фамилия Родителя'
    inputParentLastName.placeholder = 'Отчество Родителя'
    inputVideo.placeholder = 'Video'
    inputDzo.placeholder = 'Дзо'
    ...
    optionOne.value = 'Виды таланта:';
    optionOne.text = 'Виды таланта:';
    optionTwo.value = 'Танцы';
    optionTwo.text = 'Танцы';
    optionThree.value = 'Песни';
    optionThree.text = 'Песни';
    optionFour.value = 'Другое';
    optionFour.text = 'Другое';
    optionOneAge.value = 'возраст';
    optionOneAge.text = 'возраст';
    optionOneCompany.value = 'Компания';
    optionOneCompany.text = 'Компания';
